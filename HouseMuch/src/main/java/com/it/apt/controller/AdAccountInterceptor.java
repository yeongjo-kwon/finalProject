...
@Component
public class AdAccountInterceptor extends HandlerInterceptorAdapter{
	private static final Logger logger = LoggerFactory.getLogger(AdAccountInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(memVo==null) {
			...
			String authCode = (String)session.getAttribute("authCodeMain");
			
			if(!authCode.equals("ACCOUNT_MNG")) {
