...
public class AdminSearchVO {
	...
	private String searchConditionN = "";
	
	/** 검색키워드 */
	private String searchKeyword = "";
	private String searchKeywordN = "";
   ...
   /**
     ...
     * @param bean 검색조건
     */
    public void setSearchVO(AdminSearchVO bean){
	...
	public String toString() {
		return "SearchVO [searchCondition=" + searchCondition + ", searchKeyword=" + searchKeyword + ", searchUseYn="
				...
				+ recordCountPerPage + ", aptNo=" + aptNo + ", answNo=" + answNo + "]";
	}
