                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                            ...
                                            <div class="media">
                                                <a href="javascript:void(0);" class="mr-25">
                                                    <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-11.jpg" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" />
                                                </a>
                                                    ...
                                                    <div class="col-12 mt-1">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6 col-md-3 text-center mb-1">
                                                                ...
                                                                <div class="avatar mb-1">
                                                                    <span class="avatar-content">
                                                                        <img src="${pageContext.request.contextPath}/resources/app-assets/images/avatars/11-small.png" alt="avatar img" width="40" height="40" />
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <div class="col-6 col-md-3 text-center mb-1">
                                                                ...
                                                                <div class="avatar mb-1">
                                                                    <span class="avatar-content">
                                                                        <img src="${pageContext.request.contextPath}/resources/app-assets/images/avatars/3-small.png" alt="avatar img" width="40" height="40" />
                                                                    </span>
                                                                </div>
