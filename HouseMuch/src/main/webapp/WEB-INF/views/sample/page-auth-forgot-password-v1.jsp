...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1">Forgot Password? ? 비밀번호 찾기 !! </h4>
    ...
    <!-- BEGIN: Page JS-->
    <script src="${pageContext.request.contextPath}/resources/app-assets/js/scripts/pages/page-auth-forgot-password.js"></script>
    <!-- END: Page JS-->
