...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ml-1">House Much</h2>
                                </a>

                                <h4 class="card-title mb-1">Adventure starts here ?? 가입 ~~ </h4>
    ...
    <!-- BEGIN: Page JS-->
    <script src="${pageContext.request.contextPath}/resources/app-assets/js/scripts/pages/page-auth-register.js"></script>
    <!-- END: Page JS-->
