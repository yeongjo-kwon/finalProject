                                        ...
                                        <div class="col-xl-6 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
                                            <div class="user-avatar-section">
                                                <div class="d-flex justify-content-start">
                                                    <img class="img-fluid rounded" src="${pageContext.request.contextPath}/resources/app-assets/images/avatars/7.png" height="104" width="104" alt="User avatar" />
                                    ...
                                    <ul class="timeline">
                                        <li class="timeline-item">
                                            ...
                                            <div class="timeline-event">
                                                ...
                                                <div class="media align-items-center">
                                                    <img class="mr-1" src="${pageContext.request.contextPath}/resources/app-assets/images/icons/file-icons/pdf.png" alt="invoice" height="23" />
                                        ...
                                        <li class="timeline-item">
                                            ...
                                            <div class="timeline-event">
                                                ...
                                                <div class="media align-items-center">
                                                    <div class="avatar">
                                                        <img src="${pageContext.request.contextPath}/resources/app-assets/images/avatars/12-small.png" alt="avatar" height="38" width="38" />
                                                    </div>
