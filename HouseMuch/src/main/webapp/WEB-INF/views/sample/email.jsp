                                ...
                                <ul class="email-media-list">
                                    <li class="media mail-read">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-20.jpg" alt="avatar img holder" />
                                            </div>
                                        ...
                                        <div class="media-body">
                                            <div class="mail-details">
                                                <div class="mail-items">
                                                    ...
                                                    <span class="text-truncate">?렞 Focused impactful open system </span>
                                                </div>
                                    ...
                                    <li class="media">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-17.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                        ...
                                        <div class="media-body">
                                            <div class="mail-details">
                                                <div class="mail-items">
                                                    ...
                                                    <span class="text-truncate">Thanks, Let's do it.?ㄹ</span>
                                                </div>
                                                <div class="mail-meta-item">
                                            ...
                                            <div class="mail-message">
                                                <p class="mb-0 text-truncate">
                                                    ...
                                                    drag챕e carrot cake candy icing bonbon. Danish caramels topping oat cake sweet roll liquorice tootsie roll
                                                    halvah.Chocolate bar jujubes jelly-o tart tiramisu croissant drag챕e cupcake jelly.
                                                </p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="media mail-read">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-7.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                        ...
                                        <div class="media-body">
                                            <div class="mail-details">
                                                <div class="mail-items">
                                                    ...
                                                    <span class="text-truncate">?몝 You have new comment...</span>
                                                </div>
                                                <div class="mail-meta-item">
                                                    <span class="mr-50 bullet bullet-success bullet-sm"></span>
                                                    <span class="mail-date">2:15 AM</span>
                                            ...
                                            <div class="mail-message">
                                                <p class="mb-0 text-truncate">
                                                    ...
                                                    Cupcake sweet bonbon tart. Sweet croissant jelly beans drag챕e chocolate cake gingerbread topping chocolate
                                                    bar lemon drops.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <li class="media mail-read">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-5.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                    ...
                                    <li class="media">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-3.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                    ...
                                    <li class="media">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-8.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                        ...
                                        <div class="media-body">
                                            <div class="mail-details">
                                                <div class="mail-items">
                                                    ...
                                                    <span class="text-truncate mb-0">Profound systemic alliance ?럦</span>
                                                </div>
                                                <div class="mail-meta-item">
                                    ...
                                    <li class="media mail-read">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-11.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                    ...
                                    <li class="media mail-read">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-10.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                    ...
                                    <li class="media mail-read">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-6.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="mail-message">
                                                <p class="mb-0 text-truncate">
                                                    Hi John,Biscuit lemon drops marshmallow. Cotton candy marshmallow bear claw. Drag챕e tiramisu cookie cotton
                                                    candy. Carrot cake sweet roll I love macaroon wafer jelly souffl챕 I love drag챕e. Jujubes jelly I love
                                    ...
                                    <li class="media">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-9.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                    ...
                                    <li class="media">
                                        <div class="media-left pr-50">
                                            <div class="avatar">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-20.jpg" alt="Generic placeholder image" />
                                            </div>
                                            <div class="user-action">
                                                <div class="custom-control custom-checkbox">
                                    ...
                                    <li class="media mail-read">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="mail-message">
                                                <p class="mb-0 text-truncate">
                                                    Hi John,Biscuit lemon drops marshmallow. Marzipan carrot cake souffl챕. Toffee tiramisu pudding cotton
                        ...
                        <div class="email-app-details">
                            ...
                            <div class="email-detail-header">
                                <div class="email-header-left d-flex align-items-center">
                                    ...
                                    <h4 class="email-subject mb-0">Focused open system ?쁼</h4>
                                </div>
                                            ...
                                            <div class="card-header email-detail-head">
                                                <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
                                                    <div class="avatar mr-75">
                                                        <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-9.jpg" alt="avatar img holder" width="48" height="48" />
                                                    </div>
                                                    <div class="mail-items">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header email-detail-head">
                                                <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
                                                    <div class="avatar mr-75">
                                                        <img src="${pageContext.request.contextPath}/resources/app-assets/images/portrait/small/avatar-s-18.jpg" alt="avatar img holder" width="48" height="48" />
                                                    </div>
                                                    <div class="mail-items">
                                                ...
                                                <div class="mail-attachments">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="javascript:void(0);" class="mb-50">
                                                            <img src="${pageContext.request.contextPath}/resources/app-assets/images/icons/doc.png" class="mr-25" alt="png" height="18" />
                                                            <small class="text-muted font-weight-bolder">interdum.docx</small>
                                                        </a>
                                                        <a href="javascript:void(0);">
                                                            <img src="${pageContext.request.contextPath}/resources/app-assets/images/icons/jpg.png" class="mr-25" alt="png" height="18" />
