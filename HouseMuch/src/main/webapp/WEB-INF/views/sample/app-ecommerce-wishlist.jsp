            ...
            <div class="content-body">
                ...
                <section id="wishlist" class="grid-view wishlist-items">
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/1.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/2.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/3.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/4.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/5.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
                            ...
                            <div class="item-name">
                                <a href="app-ecommerce-details.html">Apple - MacBook Air짰 (Latest Model) - 13.3" Display - Silver</a>
                            </div>
                            <p class="card-text item-description">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/6.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/7.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/8.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="item-img text-center">
                            <a href="app-ecommerce-details.html">
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/9.png" class="img-fluid" alt="img-placeholder" />
                            </a>
                        </div>
                        <div class="card-body">
                            <div class="item-wrapper">
