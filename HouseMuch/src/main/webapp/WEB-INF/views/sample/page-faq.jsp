        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="faq-search-filter">
                    <div class="card faq-search" style="background-image: url('${pageContext.request.contextPath}/resources/app-assets/images/banner/banner.png')">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-12">
                            <div class="faq-navigation d-flex justify-content-between flex-column mb-2 mb-md-0">
                                ...
                                <!-- FAQ image -->
                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/illustration/faq-illustrations.svg" class="img-fluid d-none d-md-block" alt="demand img" />
                            </div>
                        </div>
                                    ...
                                    <div class="collapse-margin collapse-icon mt-2" id="faq-payment-qna">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="faq-payment-three" class="collapse" aria-labelledby="paymentThree" data-parent="#faq-payment-qna">
                                                <div class="card-body">
                                                    Tart gummies drag챕e lollipop fruitcake pastry oat cake. Cookie jelly jelly macaroon icing jelly beans
                                                    souffl챕 cake sweet. Macaroon sesame snaps cheesecake tart cake sugar plum. Dessert jelly-o sweet
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="faq-payment-four" class="collapse" aria-labelledby="paymentFour" data-parent="#faq-payment-qna">
                                                <div class="card-body">
                                                    Cheesecake muffin cupcake drag챕e lemon drops tiramisu cake gummies chocolate cake. Marshmallow tart
                                    ...
                                    <div class="collapse-margin collapse-icon mt-2" id="faq-delivery-qna">
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="deliveryFour" data-toggle="collapse" role="button" data-target="#faq-delivery-four" aria-expanded="false" aria-controls="faq-delivery-four">
                                                <span class="lead collapse-title">
                                                    My shipment status shows that it?셲 out for delivery. By when will I receive it?
                                                </span>
                                            </div>
                                    ...
                                    <div class="collapse-margin collapse-icon mt-2" id="faq-my-order-qna">
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="myOrderTwo" data-toggle="collapse" role="button" data-target="#faq-my-order-two" aria-expanded="false" aria-controls="faq-my-order-two">
                                                <span class="lead collapse-title">
                                                    I haven?셳 received the refund of my returned shipment. What do I do?
                                                </span>
                                            </div>
                                    ...
                                    <div class="collapse-margin collapse-icon mt-2" id="faq-product-qna">
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="productTwo" data-toggle="collapse" role="button" data-target="#faq-product-two" aria-expanded="false" aria-controls="faq-product-two">
                                                <span class="lead collapse-title">
                                                    The status for my shipment shows as ?쁭ot picked up?? What do I do?
                                                </span>
                                            </div>
