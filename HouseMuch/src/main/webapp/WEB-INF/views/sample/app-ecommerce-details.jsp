                            ...
                            <div class="row my-2">
                                <div class="col-12 col-md-5 d-flex align-items-center justify-content-center mb-2 mb-md-0">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <img src="${pageContext.request.contextPath}/resources/app-assets/images/pages/eCommerce/1.png" class="img-fluid product-img" alt="product image" />
                                    </div>
                                </div>
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-12 col-md-4 mb-4 mb-md-0">
                                    <div class="w-75 mx-auto">
                                        ...
                                        <p class="card-text">Marshmallow biscuit donut drag챕e fruitcake. Jujubes wafer cupcake.</p>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 mb-4 mb-md-0">
                                    <div class="w-75 mx-auto">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/elements/apple-watch.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-50">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/elements/macbook-pro.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/elements/homepod.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/elements/magic-mouse.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="${pageContext.request.contextPath}/resources/app-assets/images/elements/iphone-x.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
