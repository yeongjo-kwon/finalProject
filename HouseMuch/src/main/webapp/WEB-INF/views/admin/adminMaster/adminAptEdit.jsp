    ...
    <div class="app-content content ">
        ...
        <div class="header-navbar-shadow"></div>
			<div class="content m-1">
				<h2 style="display:inline;">${apartVo.aptName } 수정하기</h2>
			</div>
                    ...
                    <div class="row match-height mt-1 align-center" >
                        ...
                        <div class="col-lg-10 col-md-6 col-12">
                            <div class="card card-developer-meetup">
                            	...
                            	<div class="card-body">
                                    <form class="form form-horizontal" name="aptFrm" method="post">
                                   		<input type="hidden" value="${apartVo.aptNo }">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="first-name" class="form-control" name="aptName" value="${apartVo.aptName }"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" name="zipcodeSeq" id="zipcodeSeq" readonly value="${apartVo.zipcodeSeq }"/>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="address" readonly value="${apartVo.address }"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="addressDetail" value="${apartVo.addressDetail }" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="number" class="form-control" name="totalHousehold" id="totalHousehold" value="${apartVo.totalHousehold }"/>
                                                    </div>
