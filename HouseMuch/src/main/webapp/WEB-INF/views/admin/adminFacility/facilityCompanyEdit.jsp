	...
	<div class="content-body">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">보수 업체 계약 수정</h2>
					<div class="breadcrumb-wrapper">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">보수 업체 계약 수정</li>
						</ol>
					</div>
				</div>
			</div>
                        ...
                        <div class="card-body">
                        	<form action="<c:url value='/admin/adminFacility/facilityCompanyEdit.do'/>" method="post" id="editFrm">
                            	...
                            	<!-- <form>  -->
                            		...
                            		<input type="hidden" name="contractNo" value="${cVo.contractNo }">
	                                <div class="col-xl-3 col-md-6 col-12 mb-1">
	                                	<input type="hidden" id="hiddenNo" value="${cVo.mngCompCtgNo }">
	                                    <div class="form-group">
	                                        <select class="form-control" id="mngCompCtgNo" name="mngCompCtgNo">
												<option value="0">분류</option>
												<c:forEach var="ctgVo" items="${ctgList }">
													<option value="${ctgVo.mngCompCtgNo }"
													<c:if test="${ctgVo.mngCompCtgNo==cVo.mngCompCtgNo }">selected="selected"</c:if>
													>
														${ctgVo.mngCompCtgName }
													</option>
												</c:forEach>
											</select>
	                                    </div>
	                                ...
	                                <div class="col-xl-9 col-md-6 col-12 mb-1">
	                                    <div class="form-group">
	 										<input type="text" class="form-control col-12" id="mngCompName" name="mngCompName" placeholder="업체명" value="${cVo.mngCompName }">									
	                                    </div>
	                                </div>
	                                ...
	                                <div class="col-xl-3 col-md-6 col-12 mb-1">
	                                    <div class="form-group">
											...
											<input type="text" class="form-control col-12" id="mngCompTel" name="mngCompTel" placeholder="-없이 숫자만 기입하세요" style="text-align:right;" value="${cVo.mngCompTel }">									
	                                    </div>
	                                </div>
	                                ...
	                                <div class="col-xl-3 col-md-6 col-12">
	                                    <div class="form-group">
											...
											<input type="text" class="form-control numeral-mask" placeholder="원" style="text-align:right;" name="price" id="price" value="${cVo.contractPrice }">
	                                    	<input type="hidden" name="contractPrice" id="contractPrice" value="value="${cVo.contractPrice }">
	                                    </div>
	                                </div>
	                                <div class="col-xl-3 col-md-6 col-12">
	                                    <div class="form-group">
	                                        <label for="contractDate">계약일</label>
		                             		<input type="text" class="form-control flatpickr-basic flatpickr-input" readonly="readonly" placeholder="YYYY-MM-DD" name="contractDate" id="contractDate" value="${cVo.contractDate }">
	                                    </div>
	                                </div>
	                                ...
	                                <div class="col-xl-3 col-md-6 col-12">
	                                	...
	                                	<div class="demo-inline-spacing" style="margin-top:10px;">
		                                    ...
		                                    <div class="custom-control custom-radio m-0">
												<input type="radio" class="custom-control-input" name="isAddFacility" id="radio2" 
													<c:if test="${cVo.isAddFacility!='Y' }">
														checked="checked"
													</c:if>
													value="N">
	                                ...
	                                <div class="col-xl-12 col-md-12 col-12">
	                                    <div class="form-group">
	                                        <textarea name="contractContent" id="smarteditor" rows="100" cols="100" style="width:100%; height:412px;" >${cVo.contractContent }</textarea>
	                                    </div>
	                                </div>

	                                <div class="col-xl-12 col-md-6 col-12">
	                                    <div class="form-group" style="text-align:center;">
	                                        <input type="submit" class="btn btn-primary center"  value="수정" id="submit">
	                                    </div>
	                                </div>
                                <!-- </form>  -->
                            	</div>
