...
<section id="userBoard" class="userBoard">
	<div class="container">
		<br> <br> <br> <br>
		<div class="form">
			<c:set var="suggBoardNo" value="${map['suggBoardNo'] }"/>
			<form class="frmUserBoard" method="post" name="frmWrite"
				action="<c:url value='/suggestBoard/suggestBoardEdit.do?suggBoardNo=${suggBoardNo }'/>">
				<div class="row">
				...
				<div class="text-center">
					<button type="submit" id="btEdit">건의 수정</button>
					<button type="button" name="btCancel" onclick="btExit()">취소</button>
				</div>
			</form>
		</div>
	</div>
