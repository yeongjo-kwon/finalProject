	...
	<!-- 일정내용a section -->
	  <section class="breadcrumbs pb-0 bg-white" style="position: fixed; width:100%; z-index:99;">
	   ...
	   <div style="width:100%; min-height:100px;" class="d-flex justify-content-between align-items-center fixed">
		...
		<h1 class="col mb-10 apt-text-dark p-0" style="font-size:2em;width:50%;line-height: 2;">아파트 일정</h1>
		</div>
		
		<!-- 일정들어갈자리 -->
		<div class="col-lg-8 p-0" style="font-size:0.9em; line-height: 3;">
		 <div id="subEvent" class="col pt-3 pr-0" style="vertical-align: center;">
			<a id="noticeNo">
				<div class="text-right">
					<!-- 날짜 S~E -->
					<h4 class="fc-event mt-10 d-inline col pr-0" name="startDate" id="startDate">StartDate</h4>
					<span id="subspan"></span>
					<h4 class="fc-event mt-10 d-inline col p-0" name="endDate" id="endDate">endDate</h4>
				</div>
				...
				<small class="text-right mt-2 d-block">+ 자세한 공지 확인하기</small>
			</a>
		 </div>
		</div>
		<hr>
